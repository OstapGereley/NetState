...
namespace NetState.Core.Impl.StatementMetadatas {
    ...
    public class StatementMetadata<TArg1, TResultult> : NotVoidStatementMetadata<TResultult>,
        IStatementMetadata<TArg1, TResultult> {
        ...
        public override async Task<StatementProofResult> TryProof(
